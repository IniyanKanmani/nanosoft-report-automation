...
input_frame.pack(pady=(20, 10), padx=60, fill='both')
...
output_frame.pack(pady=(10, 20), padx=60, fill='both')
...
def choose_ecommerce_site(site):
    global ecommerce_site
    ecommerce_site = site
    print(ecommerce_site)


choose_site_frame = customtkinter.CTkFrame(master=main_frame, width=250, height=50)
choose_site_frame.pack(pady=(25, 20), padx=60, fill=None, anchor='center')

amazon_button = customtkinter.CTkButton(master=choose_site_frame, text='Amazon', command=lambda: choose_ecommerce_site('Amazon'), width=100)
amazon_button.pack(side='left', padx=7, pady=7)

ebay_button = customtkinter.CTkButton(master=choose_site_frame, text='Ebay', command=lambda: choose_ecommerce_site('Ebay'), width=100)
ebay_button.pack(side='right', padx=7, pady=7)
